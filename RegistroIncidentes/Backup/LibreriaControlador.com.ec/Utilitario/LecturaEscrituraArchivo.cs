...
namespace LibreriaControlador.com.ec.Utilitario
{
    public class LecturaEscrituraArchivo
    {
        ...
        {
            pathGuardar = @"C:\REG_INCIDENTE\" + pathSave;
        }
        ...
        public void escritura_archivo_string_ex(Exception e)
        {
            string mensaje = e.Message + "\t"+e.StackTrace + "\r";
            string tmpath;
            tmpath = pathGuardar + @"\" + cambiar_fecha(System.DateTime.Now.Date.ToString()) + ".txt";
            try
            {
